        ...
        <form class="row g-3 formulario" action="up-projeto.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-2">
                ...
                <select name="cidade" class="form-select selecao" required>
                    <?php
                    $cidades = [
                        "Campinas","Americana","Artur Nogueira","Cosmópolis","Engenheiro Coelho","Holambra","Hortolândia","Indaiatuba","Itatiba","Jaguariúna","Monte Mor","Nova Odessa","Paulínia","Pedreira","Santa Bárbara D’Oeste","Santo Antônio de Posse","Sumaré","Valinhos","Vinhedo","Morungaba","Rio de Janeiro","Brasília","Salvador","Fortaleza","Belo Horizonte","Manaus","Curitiba","Recife","Porto Alegre","Belém","Goiânia","Guarulhos","São Luís","São Gonçalo","Maceió","Duque de Caxias","Natal","Teresina","Campo Grande","Nova Iguaçu","João Pessoa","São Bernardo do Campo","Santo André","Osasco","Jaboatão dos Guararapes","Ribeirão Preto","Uberlândia","Contagem","Sorocaba","Aracaju","Feira de Santana","Cuiabá","Joinville","Londrina","Juiz de Fora","Aparecida de Goiânia","Ananindeua","Porto Velho","Florianópolis","Macapá","Santos","Serra","Caxias do Sul","Mauá","São José do Rio Preto","Mogi das Cruzes","Diadema","Maringá"
                    ];
            ...
            <div class="col-md-2">
                ...
                <select name="estado" class="form-select selecao" required>
                    <?php
                    $estados = [
                        "São Paulo","Acre","Alagoas","Amapá","Amazonas","Bahia","Ceará","Distrito Federal","Espírito Santo","Goiás","Maranhão","Mato Grosso","Mato Grosso do Sul","Minas Gerais","Pará","Paraíba","Paraná","Pernambuco","Piauí","Rio de Janeiro","Rio Grande do Norte","Rio Grande do Sul","Rondônia","Roraima","Santa Catarina","Sergipe","Tocantins"
                    ];
